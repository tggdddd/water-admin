...
public class WaterShopController {
	...
	@Autowired
	private IWaterShopModelService waterShopModelService;
	@Autowired
	...
	public Result<String> add(@RequestBody WaterShopPage waterShopPage) {
		...
		waterShopService.saveMain(waterShop, waterShopPage.getWaterShopModelList(), waterShopPage.getWaterShopItemList());
	...
	public Result<String> edit(@RequestBody WaterShopPage waterShopPage) {
		...
		waterShopService.updateMain(waterShop, waterShopPage.getWaterShopModelList(), waterShopPage.getWaterShopItemList());
	 ...
	 * @return
	 */
	//@AutoLog(value = "规格通过主表ID查询")
	@ApiOperation(value = "规格主表ID查询", notes = "规格-通主表ID查询")
	@GetMapping(value = "/queryWaterShopModelByMainId")
	public Result<List<WaterShopModel>> queryWaterShopModelListByMainId(@RequestParam(name = "id", required = true) String id) {
		List<WaterShopModel> waterShopModelList = waterShopModelService.selectByMainId(id);
		return Result.OK(waterShopModelList);
	}
	 ...
	 * @return
	 */
	//@AutoLog(value = "售卖商品通过主表ID查询")
	@ApiOperation(value = "售卖商品主表ID查询", notes = "售卖商品-通主表ID查询")
	...
	public ModelAndView exportXls(HttpServletRequest request, WaterShop waterShop) {
		...
		for (WaterShop main : waterShopList) {
			...
			List<WaterShopModel> waterShopModelList = waterShopModelService.selectByMainId(main.getId());
			vo.setWaterShopModelList(waterShopModelList);
		...
		for (Map.Entry<String, MultipartFile> entity : fileMap.entrySet()) {
			...
			try {
				...
				for (WaterShopPage page : list) {
					...
					waterShopService.saveMain(po, page.getWaterShopModelList(), page.getWaterShopItemList());
				}
